...
export const showSuccessToast = (message: string = 'Oops, there was an error processing your request.', description: string) => {
...
export const showInfoToast = (message: string = 'Oops, there was an error processing your request.', description: string) => {
...
export const showWarningToast = (message: string = 'Oops, there was an error processing your request.', description: string) => {
